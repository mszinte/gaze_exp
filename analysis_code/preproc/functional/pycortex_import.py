...
-----------------------------------------------------------------------------------------
Executions:
python pycortex_import.py /scratch/mszinte/data gaze_exp sub-001 327
-----------------------------------------------------------------------------------------
...
os.system(freesurfer_cmd)
file_list = sorted(glob.glob("{}/{}/derivatives/pp_data/{}/func/fmriprep_{}/*.nii.gz".format(main_dir, project_dir, subject, high_pass_type)))
