...
-----------------------------------------------------------------------------------------
Exemple:
python pybest_sbatch.py /scratch/mszinte/data gaze_exp sub-001 T1w 4 0 martin.szinte
python pybest_sbatch.py /scratch/mszinte/data gaze_exp sub-001 MNI152NLin2009cAsym 4 0 martin.szinte
python pybest_sbatch.py /scratch/mszinte/data gaze_exp sub-001 fsLR_den-170k 8 0 martin.szinte

python pybest_sbatch.py /scratch/mszinte/data gaze_exp sub-002 T1w 4 0 martin.szinte
python pybest_sbatch.py /scratch/mszinte/data gaze_exp sub-002 MNI152NLin2009cAsym 4 0 martin.szinte
python pybest_sbatch.py /scratch/mszinte/data gaze_exp sub-002 fsLR_den-170k 8 0 martin.szinte
-----------------------------------------------------------------------------------------
